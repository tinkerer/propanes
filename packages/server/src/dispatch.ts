...
export const COS_REPLY_DISPATCH_HINT = `(Implement directly. If this task generates code or docs changes: commit and open a PR for your work. After opening a PR, monitor the CI, conflicts and reviewer comments, make any updates required to pass CI, resolve conflicts and get reviewer approval. When done, wrap a 1–4 sentence summary — changed files/commits, what you verified, follow-ups — in <cos-reply>…</cos-reply> tags; only wrapped text reaches the Inbox thread.)`;
